...
internal object ItemSectionProtoFingerprint : Fingerprint(
    name = "<clinit>",
    filters = listOf(literal(50_195_462L)),
)

internal object ItemSectionConsumerFingerprint : Fingerprint(
    strings = listOf("comment-item-section", "community-tab-chip-posts-section"),
)

internal object ElementRendererProtoFingerprint : Fingerprint(
    name = "<clinit>",
    filters = listOf(literal(153_515_154L)),
    custom = { method, _ -> method.instructions.count { it.opcode == Opcode.CONST_CLASS } == 1 },
)
